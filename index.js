...
function getPizzaOrder() {
  ...
  function crust(userResponse) {
    if(regular === 'basePrice'){
      console.log('Pizza is' + 'basePrice');
    } else if (regular ===  'thickCrustUpcharge') {
      console.log('Pizza is' + 'basePrice' + "thickCrustUpcharge");
  ...
  // YOUR CODE HERE
const pizza.extraCheese = (yes) => {
  if (yes === 'extraCheeseUpcharge' ){
    return true;
  } else {
    return false;
  }
